...
namespace _011_tiling
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // 1부터 30까지 3xn Tile 경우의 수(Tile3)
            for (int i = 1; i <= 30; i++)
            {
                Console.WriteLine("Tile3{0:2} : {1}", i, Tile3(i));
            }
        }
